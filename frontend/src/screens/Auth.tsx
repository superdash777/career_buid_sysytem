    ...
    <GridBg className="flex min-h-screen items-center justify-center bg-[var(--bg)]">
      <div className="w-full max-w-[420px] px-5">
        <div className="rounded-2xl border border-[var(--line)] bg-[var(--paper)] p-8 shadow-[var(--shadow-soft)]">
          ...
          {/* Google OAuth (visual only — backend not wired) */}
          <button
            type="button"
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-[var(--line)] bg-[var(--paper)] px-4 py-3 text-sm font-medium text-[var(--ink)] transition-colors hover:border-[var(--blue-deep)]"
          >
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-[var(--muted)]">или через email</span>
            <div className="h-px flex-1 bg-[var(--line)]" />
          </div>
