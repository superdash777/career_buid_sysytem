...
class PlanGenerator:
    ...
    def _system_policy() -> str:
        return (
            ...
            "4) В блоке обучения рекомендуй только книги. Не рекомендуй курсы, тренинги, буткемпы и подписки.\n"
